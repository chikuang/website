...
UVic uses the traditional colored shield and full university name requested
by the author. The shield retains its blue, red and gold; only the black
lettering becomes white in dark mode. Its tiny embedded blue-field bitmap
has been replaced by the corresponding vector gradient. Waterloo uses black lettering in light mode and the original
white lettering in dark mode, with its colored shield intact. Mila switches
from purple to white. GSU uses the stacked mark in Georgia State blue (#0039A6) and red (#CC0000),
with white lettering and flame in dark mode while retaining the red underline.
McGill uses its two official variants. Logo colors are selected through the
site’s existing theme control.
